...
\medskip
Aside: Considering the revision's argument allowing for equal distribution of the initial $n - 1$ tasks, the third greedy job would be split in half, leaving each machine with $1.5$ work. Adding the last job of cost $3$ causes the greedy scheduling to take $4.5$ units of time, which is exactly $\frac{3}{2} \cdot 3$.
